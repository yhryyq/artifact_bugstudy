...
def dfs(graph, start_vertex, visited=None):
    ...
    while stack:
        ...
        if current not in visited:
            ...
            print(f"current vertex: {current}, line num: {current_data.line_number}, func name: {current_data.function_name}")
            print(current_data)
...
print(f"from func: {function_name}, line numb: {start_line_number}, reachable func and line: {reachable_info}")
